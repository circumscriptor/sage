...
#define SAGE_GET_CVAR(Name) Sage::Console::VirtualConsole::GetCVarManager()->Get(Name)

#define SAGE_REGISTER_CVAR(Type, Name, Description, Flags, ...)                                                        \
    Sage::Console::VirtualConsole::GetCVarManager()->Register##Type(Name, Description, Flags, __VA_ARGS__)
